...
export default function Header() {
  ...
  const [flagForLog, setFlag] = useState(false)

  const showModal = () => {
    if (flagForLog === false) {
      console.log(`ЛОГ ДЛЯ ДЕНИСА: Ворнинг выводится из-за использования модального окна библиотеки Ant design(либа по типу material ui). Можно убрать, если убрать стрикт мод, но это глупо. Либо убирать рефами где-то в нод модулях.` );
      setFlag(true)
    }
